...
@interface UBNode : NSObject

@property (nonatomic, assign, readonly) NSUInteger nodeHash;/*nodeSelf hash值*/
@property (nonatomic, strong) id nodeSelf;/*自己*/
@property (nonatomic, strong) UBNode *nodeSuper;/*父节点,为空则为头节点*/
@property (nonatomic, assign) NSInteger nodeIndex;/*同父节点所在的索引*/
...
@property (nonatomic, strong) NSMutableArray <UBNode*>*nodeChilds;/*孩子,为空则为尾节点*/
